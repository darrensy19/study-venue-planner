...
- **Review record**: `reviews/IMP-008.md` (not yet created — the reviewer creates it)
- **User decisions required**: —
- **Next action**: Awaiting Codex Terra round-1 review of `f0dabe6` per the handoff prompt below.
