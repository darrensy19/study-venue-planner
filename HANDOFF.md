...
- **Baseline commit**: `be3d3c2aec1b80b865abae1fdae68d845bf9aac7`
...
- **Next action**: Primary (this session) implements against the acceptance criteria above, then runs the pre-gate.
