...
| `IMP-012` | 2026-09-03 | implementation | Phase 1 step 6: frontend shell + fixture-driven HTML generator |
...
| `IMP-022` | 2026-09-06 | implementation | Slice 3: outbound feasibility (outbound_admissible, resolve_outbound_service, validate_outbound_transport) + outbound_transport hand-curation |
